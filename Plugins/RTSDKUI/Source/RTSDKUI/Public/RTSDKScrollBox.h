...
#include "RTSDKScrollBox.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FRTSDKOnUserScrolledEvent, float, CurrentOffset);

/**
 * An arbitrary scrollable collection of widgets.  Great for presenting 10-100 widgets in a list.  Doesn't support virtualization.
 */
UCLASS()
class RTSDKUI_API URTSDKScrollBox : public UPanelWidget
{
	GENERATED_BODY()

public:

	URTSDKScrollBox(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "RTS UMG Scroll Box")
		float NotchDistance;
	...
	/**
	 * Sets the distance between 'notches' when MovesNotched is true. 
	 * Bar snaps to 0, multiples of this number, and max, whatever is closest/adjacent
	 */
	UFUNCTION(BlueprintCallable, Category = "Widget")
		void SetNotchDistance(float InNotchDistance);

	/**
	 * Gets the distance between 'notches' when MovesNotched is true. 
	 * Bar snaps to 0, multiples of this number, and max, whatever is closest/adjacent
	 */
	UFUNCTION(BlueprintCallable, Category = "Widget")
	...
	/**
	 * Sets whether the scroll bar moves freely or in notched increments
	 * The distance between notches is set by NotchDistance.
	 */
	UFUNCTION(BlueprintCallable, Category = "Widget")
		void SetMovesNotched(bool InMovesNotched);

	/**
	 * Gets whether the scroll bar moves freely of in notched increments.
	 * The distance between notches is set by NotDistance
	 */
	UFUNCTION(BlueprintCallable, Category = "Widget")
	...
	UPROPERTY(BlueprintAssignable, Category = "Button|Event")
		FRTSDKOnUserScrolledEvent OnUserScrolled;
	...
	UFUNCTION(BlueprintCallable, Category = "Widget")
		void ScrollWidgetIntoView(UWidget* WidgetToFind, bool AnimateScroll = true, ERTSDKDescendantScrollDestination ScrollDestination = ERTSDKDescendantScrollDestination::IntoView, float Padding = 0);
...
protected:
	...
	TSharedPtr<class SRTSDKScrollBox> MyScrollBox;
