...
*/
UCLASS()
class URTSDKComplexWalkingBasedVelocityDirector : public URTSDKGameSimProcessorBase
{
	GENERATED_BODY()
public:
...
*/
UCLASS()
class URTSDKComplexWalkingAirVelocityDirector : public URTSDKGameSimProcessorBase
{
	GENERATED_BODY()
public:
	//sets some defaults in the class default object
...
*/
UCLASS()
class URTSDKComplexWalkingAngularVelocityDirector : public URTSDKGameSimProcessorBase
{
	GENERATED_BODY()
public:
	//sets some defaults in the class default object
