...
ARTSDKUnitSpawner::ARTSDKUnitSpawner(const FObjectInitializer& ObjectInitializer)
...
UArrowComponent* ARTSDKUnitSpawner::GetArrowComponent() const { return ArrowComponent; }
#endif